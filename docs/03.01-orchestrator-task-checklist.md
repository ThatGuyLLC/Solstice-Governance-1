...
## 1. One-Time Setup / Admission

| Done | Task                                                                          | Timing             | Reference                                                                                                                                                                           |
| ---- | ----------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ ]  | Review Orchestrator requirements                                              | Before applying    | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                      |
| [ ]  | Prepare Orchestrator identity and team information                            | Before applying    | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Prepare funding and operating plan                                            | Before applying    | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Identify expected payer/operator relationships                                | Before applying    | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Document proposed FPV measurement approach                                    | Before applying    | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                      |
| [ ]  | Submit Orchestrator application                                               | Once               | [Open GitHub Issue](https://github.com/filecoin-project/Solstice-Governance/issues/new)                                                                                             |
| [ ]  | Disclose controlled and financially connected addresses                       | During application | [Disclosure Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                |
| [ ]  | Disclose common-control relationships                                         | During application | [Disclosure Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                |
| [ ]  | Confirm Orchestrator wallet satisfies governance-separation requirements      | Before admission   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                      |
| [ ]  | Establish controlling wallet                                                  | Before admission   | [Wallet Guidance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                 |
| [ ]  | Secure wallet using multisig/Safe and hardware-backed signers where practical | Before operating   | [Wallet Guidance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                 |
| [ ]  | Confirm admission has been approved and executed                              | Once               | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Confirm Orchestrator appears correctly in the registry                        | After admission    | [Orchestrator Registry](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md#2312-orchestrator-registry-admitted-orchestrators) |

---

## 2. Post-Admission Setup

**Complete within 7 days of admission.**

| Done | Task                                         | Reference                                                                                                                                    |
| ---- | -------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [ ]  | Publish required Orchestrator declaration    | [Declaration Requirements](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Include service description                  | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Include current public contact information   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Include controlling wallet                   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Include registered payer/operator pairs      | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Include applicable service-contract metadata | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Publish FPV measurement methodology          | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Verify all published information is accurate | [Repository](https://github.com/filecoin-project/Solstice-Governance)                                                                        |

---

## 3. Every New Client / Deal
...
| ---- | ----------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [ ]  | Source and support genuine paying storage clients           | Ongoing   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Monitor payer/operator settlement activity                  | Ongoing   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Monitor FPV generated during the quarter                    | Ongoing   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Compare internal records against public settlement activity | Regularly | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Investigate unusual payment or volume activity              | As needed | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md)           |
| [ ]  | Investigate FPV discrepancies                               | As needed | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md)           |
| [ ]  | Review registered payer/operator pairs                      | Regularly | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)         |
| [ ]  | Keep public contact information current                     | As needed | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Keep controlling wallet information current                 | As needed | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Keep common-control disclosures current                     | As needed | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Keep FPV measurement methodology current                    | As needed | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md) |
| [ ]  | Monitor repository for governance changes                   | Ongoing   | [Repository](https://github.com/filecoin-project/Solstice-Governance)                                                          |
| [ ]  | Review published program changes                            | Ongoing   | [Change Log](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/06-changelog.md)                           |
| [ ]  | Monitor relevant governance issues                          | Ongoing   | [GitHub Issues](https://github.com/filecoin-project/Solstice-Governance/issues)                                                |

---

## 5. Treasury & Wallet Management
...
## 10. Quarterly Compliance Check

| Done | Check                                            | Timing        | Reference                                                                                                                       |
| ---- | ------------------------------------------------ | ------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [ ]  | No wash-trading activity was counted             | Quarter close | [Verification Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | No self-dealing volume was counted               | Quarter close | [Verification Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | No fraudulent payer/operator registration exists | Quarter close | [Verification Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | FPV was not knowingly misreported                | Quarter close | [Verification Rules](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Required disclosures are current                 | Quarter close | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)  |
| [ ]  | Public contact information is current            | Quarter close | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)  |
| [ ]  | Governance requests were answered on time        | Quarter close | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md)            |
| [ ]  | FPV was posted                                   | Quarter close | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)  |
| [ ]  | FPV verification was completed                   | Quarter close | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md)            |
| [ ]  | Material discrepancies were disclosed            | Quarter close | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md)            |
| [ ]  | Quarterly Community Report was published         | Quarter close | [Quarterly Reports](https://github.com/filecoin-project/Solstice-Governance/tree/main/docs/quarterly-reports)                   |
...
## 12. Prepare for Next Quarter

| Done | Task                                                     | Reference                                                                                                                                    |
| ---- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
| [ ]  | Review active clients                                    | —                                                                                                                                            |
| [ ]  | Review existing payer/operator registrations             | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                       |
| [ ]  | Identify new clients expected next quarter               | —                                                                                                                                            |
| [ ]  | Identify new payer/operator pairs requiring registration | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Review expected payment volume                           | —                                                                                                                                            |
| [ ]  | Review currently admitted assets                         | [Current Parameters](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md#24-parameters) |
| [ ]  | Review currently admitted Filecoin Pay contracts         | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                       |
| [ ]  | Review FPV measurement-rule changes                      | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)               |
| [ ]  | Review governance changes from the previous quarter      | [Change Log](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/06-changelog.md)                                         |
| [ ]  | Review reference-indexer changes once available          | TBD                                                                                                                                          |
| [ ]  | Update internal operating procedures where required      | —                                                                                                                                            |

---

## 13. As Needed — Dispute / Verification Request

| Done | Task                                                | Timing         | Reference                                                                                                            |
| ---- | --------------------------------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------- |
| [ ]  | Review the issue or challenge                       | Immediately    | [GitHub Issues](https://github.com/filecoin-project/Solstice-Governance/issues)                                      |
| [ ]  | Identify affected payer/operator pair or FPV figure | Immediately    | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Review relevant on-chain activity                   | Immediately    | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Gather evidence of the genuine client relationship  | As needed      | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Gather relevant business records                    | As needed      | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Obtain client confirmation if required              | As needed      | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Obtain payer-wallet attestation if required         | As needed      | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Respond to request                                  | Within 7 days  | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |
| [ ]  | Monitor governance decision                         | Until resolved | [GitHub Issues](https://github.com/filecoin-project/Solstice-Governance/issues)                                      |
| [ ]  | Complete required operational changes               | After decision | [Runbook](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/04-quarterly-review-and-runbook.md) |

---

## 14. As Needed — Controlling Wallet Change

| Done | Task                                                     | Reference                                                                                                                                                                           |
| ---- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ ]  | Secure replacement controlling wallet                    | [Wallet Guidance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                 |
| [ ]  | Notify SRA Governance                                    | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Request `Replace(old, new)`                              | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Confirm replacement executed                             | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Confirm rewards route to replacement wallet              | [Governance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md)                                                              |
| [ ]  | Confirm registry reflects new wallet                     | [Orchestrator Registry](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/02-solstice-program-governance.md#2312-orchestrator-registry-admitted-orchestrators) |
| [ ]  | Update public Orchestrator declaration                   | [Guidelines](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                      |
| [ ]  | Rotate affected credentials or keys                      | [Wallet Guidance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                 |
| [ ]  | Review historical transactions for unauthorized activity | [Wallet Guidance](https://github.com/filecoin-project/Solstice-Governance/blob/main/docs/03-orchestrator-operational-guidelines.md)                                                 |

---

## 15. Operational Tooling Still Pending
